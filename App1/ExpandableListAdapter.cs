...
namespace App1
{
    ...
    class ExpandableListAdapter : BaseExpandableListAdapter
    {
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
        {
            ...
            //View ind = convertView.FindViewById<View>(Resource.Id.na);
            //if (headerTitle.Name == "All Contacts")
            //{
            ...
            //expandList.SetIndicatorBounds(expandList.Right - 40 , expandList.Width);

            //if (isExpanded)
            //{
            //    Resource.Drawable.down
            //}

            return convertView;
        }

        public string GetChildAtPosition(int childPosition , int groupPosition)
        {
            var lstChild = _listDataChild[_listDataHeader[groupPosition]];
            return lstChild[childPosition] ;
        }
        public string GetHeaderAtPosition(int groupPosition)
        {
            return _listDataHeader[groupPosition].Name;
