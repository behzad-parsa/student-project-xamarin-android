...
public class ContactAdapter_ContactFilter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.ContactAdapter+ContactFilter, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ContactAdapter_ContactFilter.class, __md_methods);
	}


	public ContactAdapter_ContactFilter ()
	{
		super ();
		if (getClass () == ContactAdapter_ContactFilter.class)
			mono.android.TypeManager.Activate ("App1.ContactAdapter+ContactFilter, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public ContactAdapter_ContactFilter (md5579855c995bdb073d8182511e793544c.ContactAdapter p0)
	{
		super ();
		if (getClass () == ContactAdapter_ContactFilter.class)
			mono.android.TypeManager.Activate ("App1.ContactAdapter+ContactFilter, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "App1.ContactAdapter, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
