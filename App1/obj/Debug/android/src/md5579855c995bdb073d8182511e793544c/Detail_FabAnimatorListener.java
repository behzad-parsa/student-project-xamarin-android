...
public class Detail_FabAnimatorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Detail+FabAnimatorListener, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Detail_FabAnimatorListener.class, __md_methods);
	}


	public Detail_FabAnimatorListener ()
	{
		super ();
		if (getClass () == Detail_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("App1.Detail+FabAnimatorListener, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public Detail_FabAnimatorListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == Detail_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("App1.Detail+FabAnimatorListener, App1, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Views.View[], Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
